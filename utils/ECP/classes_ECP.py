...
class CurrentPatientECP:
    ...
    def save_data(
        ...
        data = [
            ...
            ('isAutoCreate', '0'),
            ('editAnatom', '1'),
            ('vizit_direction_control_check', '1'),
        ...
        response = self._connect.post('https://ecp38.is-mis.ru/', params=params, headers=self._headers, data=dict_data)
