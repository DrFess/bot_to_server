...
class CurrentPatientECP:
    ...
    def save_data(
        ...
        data = [
            ...
            ('EvnSection_IsPaid', '1'),
            ('EvnSection_IndexRep', '0'),
            ('EvnSection_IndexRepInReg', '1'),
            ('MedPersonal_aid', '0'),
            ('MedPersonal_did', '0'),
            ...
            ('PainIntensity_id', ''),
            ('Diag_eid', w_mkb),  # при травмах id внешней причины
            ('HTMedicalCare_isCurrentES', '1'),
        ...
        #     'ignoreControlOMS': '0',
        #     'ignoreCheckEvnUslugaInESOMS': '0',
        #     'ignoreCheckEvnUslugaInspectionDaily': '0',
        #     'ignoreCheckKSGAndSopDiag': '0',
        #     'ignoreCheckEvnConciliumRehab': '0',
        #     'ignoreConfirmedAutoCreatedPersonDisps': '',
        #     'checkIsOMS': '1',
        #     'AdditionalNewbornResultFields': '{"179":false}',
        #     'ignoreCheckTimePainFieldsEmpty': '1',
        #     'ignoreCheckPointsGraceFieldsEmpty': '1',
        #     'accessType': 'edit',
        #     'PaidEvnId': '',
        #     'RankinScale_id': '',
        #     'BedProfile': '',
        #     'EvnSection_InsultScale': '',
        #     'EvnDie_id': '',
        #     'EvnLeave_id': '',
        #     'EvnOtherLpu_id': '',
        #     'EvnOtherSection_id': '',
        #     'EvnOtherSectionBedProfile_id': '',
        #     'EvnOtherStac_id': '',
        #     'EvnSection_id': self.evn_section_id,
        #     'EvnSection_pid': self.evn_ps_id,
        #     'EvnSection_IsPaid': '1',
        ...
        #     'HTMCareKind_id': '',
        #     'HTMedicalCareClass_id': '',
        #     'LpuSectionProfile_eid': '380101000000301',
        #     'EvnSection_IsRehab': '0',
        #     'DrugTherapyScheme_ids': '',
        #     'DrugTherapySchemeVimis_ids': '',
        #     'EvnSection_CoeffCTP': '0',
        #     'EvnSection_IndexRep': '0',
        #     'EvnSection_IndexRepInReg': '1',
        #     'LpuSectionTransType_id': '',
        #     'LpuSectionBedProfileLink_fedid': '380101000000438',
        #     'LpuSectionBedProfileLink_fedoid': '',
        #     'EvnSection_insideNumCard': '',
        #     'PrehospTrauma_id': '',
        #     'EvnSection_IsST': '',
        ...
        #     'EvnDirectionHTM_id': '',
        #     'Mes_tid': '',
        #     'Mes_sid': '380101000001018',
        #     'Mes_kid': '',
        #     'StandartExecutionLink_id': '',
        #     'isMdrkScaleExsist': 'false',
        #     'isMdrkScaleExsistInt': '1',
        #     'ACSType_id': '',
        #     'EvnPS_id': self.evn_ps_id,
        #     'IsDeleteSpecificCVI': '1',
        #     'EvnSection_disTime': time_end,
        #     'EvnSection_IsAdultEscort': '1',
        #     'EvnSection_AdultEscortPeriod': '',
        #     'EvnSection_IsMedReason': '1',
        #     'Diag_id': diag_id,
        #     'EvnSection_PhaseDescr': '',
        #     'Diag11_Code': 'null',
        #     'DiagValidityType_id': '3',
        #     'DiagSetPhase_id': '2',
        #     'DeseaseBegTimeType_id': 'null',
        #     'DeseaseType_id': 'null',
        #     'AnatomicLocal': 'null',
        #     'Diag_eid': 'null',
        #     'EvnSection_PrehospTrauma_id': 'null',
        #     'EvnSection_Absence': '',
        #     'LpuSectionProfile_id': '380101000000301',
        #     'LpuSectionBedProfile_id': '380101000000332',
        ...
        #     'Org_aid': 'null',
        #     'LpuSection_aid': 'null',
        #     'MedStaffFact_aid': 'null',
        #     'Diag_aid': 'null',
        #     'LpuUnitType_oid': 'null',
        #     'LpuSection_oid': 'null',
        #     'LpuSectionBedProfile_oid': 'null',
