...
async def scheduler():
    ...
    aioschedule.every().day.at('10:00').do(hospitalisation_stac_handler.discharge_patient)
    aioschedule.every().day.at('22:00').do(hospitalisation_stac_handler.discharge_patient)
